...
namespace ImageProcess2
{
	...
	public class BitmapFilter
	{
        ...
        public static bool CustomSubtract(Bitmap source, Bitmap staticImg, Bitmap bg, byte threshold)
        {
        ...
        public static void CustomResize(ref Bitmap source, ref Bitmap result, int width, int height)
        {
